...
namespace VRisingServerManager
{
    public partial class GameSettingsEditor : Window
    {
        ...
        private void SetupDefaultSettings()
        {
            ...
            fakeAchievements.Add(new Achievement() { ID = -1770927128, Name = "1. 收集遗骸", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = 436375429, Name = "2. 舞刀弄剑", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = -1400391027, Name = "3. 掌握魔法", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = -2071097880, Name = "4. 骨制护甲", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = 1695239324, Name = "5. 向森林进发", Unlocked = false });
            fakeAchievements.Add(new Achievement    () { ID = 1502386974, Name = "6. 碎岩利器", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = 1694767961, Name = "7. 暗影领主", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = -1899098914, Name = "8. 筑起工事", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = 560247139, Name = "9. 为猎杀做好准备", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = -1995132640, Name = "10. 觅血", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = -1434604634, Name = "11. 图书馆里的第一本书", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = 1668809517, Name = "12. 扩展领地", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = 134993992, Name = "13. 传送门", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = 334973636, Name = "14. 建造城堡", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = 606418711, Name = "15. 古堡领主", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = -892747762, Name = "16. 仆从", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = -437605270, Name = "17. 黑暗军团", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = -2104585843, Name = "18. 统帅宝座", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = 1805684941, Name = "19. 高耸入云的城堡", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = -699165894, Name = "20. 夜幕战马", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = 1861267375, Name = "21. 吸血鬼帝国", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = -327597689, Name = "22. 灵魂之石", Unlocked = false });
            fakeAchievements.Add(new Achievement() { ID = 1762480233, Name = "23. 光明之血", Unlocked = false });
